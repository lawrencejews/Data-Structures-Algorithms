//Class representing a Graph. Adjacency List.
...
class Graph {
    ...
    removeEdge(node1, node2) {
        ...
        if (badIndices) {
            ...
            this.adjList[node1].splice(indexOfNode1, 1);
            this.adjList[node2].splice(indexOfNode1);
        }
    }
    ...
    breadthFirstTraversal(startingNode, func = console.log) {
        if (startingNode === undefined) {
            return 'N o starting node was provided';
        }
